package oliveira.alberto.mylifemanager.data.database
...
import oliveira.alberto.mylifemanager.data.daos.GoalDao
...
@Database(entities = [GoalsEntity::class, GoalEntity::class], version = 1)
